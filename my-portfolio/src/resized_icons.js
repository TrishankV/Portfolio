...
const SocialIcons = () => {
  ...
  return (
    ...
    {resizedIcons.linkedin && (
        <a href="#" onClick={() => handleClick('https://www.linkedin.com', linkedinRef)} className="relative">
      ...
      {resizedIcons.github && (
        <a href="#" onClick={() => handleClick('https://github.com', githubRef)} className="relative">
      ...
      {resizedIcons.instagram && (
        <a href="#" onClick={() => handleClick('https://www.instagram.com', instagramRef)} className="relative">
      ...
      {resizedIcons.twitter && (
        <a href="#" onClick={() => handleClick('https://twitter.com', twitterRef)} className="relative">
